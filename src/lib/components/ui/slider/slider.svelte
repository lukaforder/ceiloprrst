...
>
	{#snippet children({ thumbItems })}
		<span
			...
			class={cn(
				"bg-input/50 data-horizontal:h-0.5 data-horizontal:w-full data-vertical:h-full data-vertical:w-0.5 relative grow overflow-hidden data-horizontal:w-full data-vertical:h-full"
			)}
		>
